...
class TestScenario1Hardening:
    """Tests for Deploy Cluster (deploy-vks.yml) hardening changes."""

    def test_deploy_cluster_no_upload_artifact_step(self, workflow_yaml_text: str):
    ...
    def test_deploy_cluster_summary_has_vcf_retrieval_command(self, workflow_yaml: dict):
    ...
    def test_deploy_cluster_summary_no_artifact_reference(self, workflow_yaml: dict):
...
class TestScenario2Hardening:
    """Tests for Deploy Metrics (deploy-vks-metrics.yml) hardening changes."""

    def test_deploy_metrics_summary_no_grafana_password(self, metrics_workflow_yaml: dict):
    ...
    def test_deploy_metrics_has_add_mask(self, metrics_workflow_yaml_text: str):
...
class TestScenario3Hardening:
    """Tests for Deploy GitOps (deploy-argocd.yml) hardening changes."""

    def test_deploy_gitops_summary_no_harbor_password(self, argocd_workflow_yaml: dict):
    ...
    def test_deploy_gitops_summary_no_argocd_password(self, argocd_workflow_yaml: dict):
    ...
    def test_deploy_gitops_summary_no_gitlab_password(self, argocd_workflow_yaml: dict):
    ...
    def test_deploy_gitops_has_add_mask(self, argocd_workflow_yaml_text: str):
