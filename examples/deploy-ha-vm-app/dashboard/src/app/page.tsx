    ...
    <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '48px 24px' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {[
            ['Compute', 'VM Service VMs'],
            ['Database', 'DSM PostgresCluster'],
            ['Networking', 'NSX VPC + LB'],
          ].map(([label, value]) => (
        ...
        <div style={{
          ...
          <div style={{ background: '#0d1117', border: '1px solid #30363d', borderRadius: '8px', padding: '18px' }}>
            ...
            <div style={{ fontSize: '20px', fontWeight: 600, color: '#58a6ff' }}>2× API VMs + 2× Web VMs</div>
          </div>
          <div style={{ background: '#0d1117', border: '1px solid #30363d', borderRadius: '8px', padding: '18px' }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 24px 0' }}>
          {[
            ...
            'Next.js dashboard deployed via git clone + npm build + systemd',
      ...
      <footer style={{ marginTop: '48px', textAlign: 'center', color: '#484f58', fontSize: '12px' }}>
        Powered by <a href="https://github.com/scafeman/vcf9-iac-onboarding" style={{ color: '#58a6ff', textDecoration: 'none' }}>vcf9-iac-onboarding</a> &middot; VCF VM Service — HA Three-Tier Application Demo
      </footer>
    </div>
  );
}
